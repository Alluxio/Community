...
For taking a new contibutor task, you don't have to register Jira, but take an issue under the project [new-contributor-tasks](https://github.com/Alluxio/new-contributor-tasks/issues). This project is set to help new contributors experience the contribution flow described in this page. For more advanced issues
 such as beginner tasks, please register your Jira account and take the tickets there.
...
and find one that is unassigned. You can press the Button **assign yourself** in order to assign the
issue to yourself. You should assign a ticket to yourself before you start working on it, so others
in the community know you are working on the issue.
...
task, in its own branch. Therefore, the following will show you how to create a branch.
...
the title will look something like **[SMALLFIX] Awesome Feature** (In the title, please replace
...
In the first line of the description box, please add a link back to the issue. The link will
look something like: `https://github.com/Alluxio/new-contributor-tasks/issues/####`
...
[Beginner Alluxio tickets](https://alluxio.atlassian.net/issues/?jql=project%20%3D%20ALLUXIO%20AND%20status%20%3D%20Open%20AND%20labels%20%3D%20Beginner%20AND%20assignee%20in%20(EMPTY)) from JIRA.
